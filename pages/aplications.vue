              ...
              <v-container fluid class="my-5">
                <v-card class="pa-3">
                  ...
                  <v-divider
                    ...
                    class="my-3"
                  ></v-divider>
                  <div v-for="app in aplications" :key="app.id">
                    <v-layout row wrap class="pa-3 align-center">
                      <v-flex xs6 sm1 md1>
                        <div class="text-center">{{ app.id }}</div>
                      </v-flex>
                      <v-flex md2>
                        <div class="text-center">{{ app.name }}</div>
                      </v-flex>
                      <v-flex md2>
                        <div class="text-center">{{ app.last }}r.</div>
                      </v-flex>
                      <v-flex md2>
                        <div class="text-center">{{ app.dataCreate }}r.</div>
                      </v-flex>
                      <v-flex md2>
                        <div class="text-center">{{ app.serverName }}</div>
                      </v-flex>
                      <v-spacer></v-spacer>
                      <v-flex
                        xs6
